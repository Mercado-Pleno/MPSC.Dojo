...
Namespace MVCVB
	Public Class FileManagerProvider
		...
		Protected Function GetUserDirectory(ByVal username As String, ByVal autocreate As Boolean) As String
		...
		Public Function GetFiles(ByVal username As String) As FileItem()
		...
		Public Function GetFileByID(ByVal username As String, ByVal fileid As String) As FileItem
		...
		Public Function MoveFile(ByVal username As String, ByVal srcpath As String, ByVal filename As String, ByVal description As String) As FileItem
	...
	Public Class FileItem
		...
		Friend Sub New(ByVal filepath As String)
			_filepath = filepath
		End Sub
		Friend Sub New(ByVal filepath As String, ByVal configpath As String, ByVal doc As XmlDocument)
			_filepath = filepath
