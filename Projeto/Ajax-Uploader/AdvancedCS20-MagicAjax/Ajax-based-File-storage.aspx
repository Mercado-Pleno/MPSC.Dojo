...
<body>
    ...
    <p>This example shows you how to use Ajax Uploader create an online file storage application. Make your file upload page more user friendly! </p>
        <div>                   
        ...
        <div>
            <asp:GridView ID="GridView1" Font-Size="11px" Font-Names="Tahoma" runat="server" DataKeyNames="FileId" AutoGenerateColumns="False"
                CellPadding="2" ForeColor="#333333" Width="600px" OnDataBinding="GridView1_DataBinding">
                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" Font-Size="11px" Font-Names="Tahoma" ForeColor="White" />
                <Columns>
                    <asp:TemplateField>
