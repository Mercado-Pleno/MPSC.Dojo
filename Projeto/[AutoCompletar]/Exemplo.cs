...
namespace AutoCompletar
{
	public partial class Exemplo : Form
	{
		...
		{
			return keys.NotIn(Keys.Escape, Keys.Home, Keys.End, Keys.PageUp, Keys.PageDown, Keys.Up, Keys.Down, Keys.Left, Keys.Right);
		}
	...
	{
		public static Boolean NotIn<T>(this T value, params T[] source)
		{
			return !value.In(source);
		}

		public static Boolean In<T>(this T value, params T[] source)
		{
