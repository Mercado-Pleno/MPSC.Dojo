...
{
	public class MatrizEspiralRunner : IExecutavel
	{
		public void Executar()
		{
			var matrizEspiral = new MatrizEspiral();
			var matriz = matrizEspiral.GerarMatrizEspiral(24, 19);
			matrizEspiral.Print(matriz);
		}
	}

	public class MatrizEspiral
	{
		public Int32[,] GerarMatrizEspiral(int quantidadeDeLinhas, int quantidadeDeColunas)
		{
